...
train_path=data/ego4d_nlq_data_for_cone/data/ego4d_data/train_v1.jsonl
eval_path=data/ego4d_nlq_data_for_cone/data/ego4d_data/val.jsonl # orig: data/ego_val.jsonl
eval_split_name=val
...
lr=.00001
adapter_module=none
exp_id=finetune_ego4d_mamba

CUDA_VISIBLE_DEVICES=${device_id} PYTHONPATH=$PYTHONPATH:. python rgnet/train.py \
    --lr_drop 120 \
    --n_epoch ${n_epoch} \
